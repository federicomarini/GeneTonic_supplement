...
gs_summary_heat(gtl = gtl_alma,
                n_gs = 5)


ggs <- ggs_graph(gtl = gtl_alma,
                 n_gs = 20)
ggs
...
```{r}
gs_volcano(res_enrich = res_enrich_a20,
           p_threshold = 0.05,
           color_by = "aggr_score",
           volcano_labels = 5,
...
gs_summary_overview(res_enrich = res_enrich_a20,
                    n_gs = 60,
...
distilled <- distill_enrichment(gtl = gtl_alma,
                                n_gs = 100,
...
signature_volcano(gtl = gtl_alma,
                  geneset_id = "GO:0060337",
                  FDR = 0.05,
                  color = "#1a81c2"
)
